...
def _map_binary_series(s: pd.Series) -> pd.Series:
    """
   Convert categorical features with exactly 2 unique values into 0/1 integers.

This function ensures a consistent, deterministic mapping for binary features 
so that the encoding remains identical during training and deployment.
